...
const novemberContainer = document.getElementById('november-plan');
const decemberContainer = document.getElementById('december-plan');
...
for (let d = new Date(startDate); d <= endDate; d.setDate(d.getDate() + 1)) {
  ...
  // Pisahkan ke bulan November & Desember
  if (d.getMonth() === 10) {
    novemberContainer.appendChild(planItem);
  } else {
    decemberContainer.appendChild(planItem);
  }
